 ...
 */
public class CustomIdpEmailVerificationAuthenticator extends AbstractIdpAuthenticator {

    private static Logger logger = Logger.getLogger(CustomIdpEmailVerificationAuthenticator.class);
    ...
    protected void authenticateImpl(AuthenticationFlowContext context, SerializedBrokeredIdentityContext serializedCtx, BrokeredIdentityContext brokerContext) {
        ...
        // IMPORTANT: Comment out this check as it causes issues with out current account link implementation
